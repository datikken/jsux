<h2 class="uk-heading">HTML5 Games</h2>
<div class="uk-flex uk-flex-column uk-width-1-1 uk-padding uk-shadow bg-white uk-margin">
    <div uk-slider>
        <div class="uk-position-relative">
            <div class="uk-slider-container uk-light">
                <ul class="uk-slider-items uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-5@m uk-grid">
                    ...
                    <li>
                        <div class="uk-panel">
                            <a class="slider_link" href="/floppy#floppy" data-turbolinks="false"></a>
                            <div class="uk-card-media-top">
